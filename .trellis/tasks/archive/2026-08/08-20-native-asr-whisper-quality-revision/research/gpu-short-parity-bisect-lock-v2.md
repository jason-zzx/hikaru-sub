# GPU short input/runtime parity bisect lock v2

## Status and stop boundary

**Frozen corrected Phase 3D pre-model identity.** This v2 lock does not authorize acquisition, ASR model construction, `encode`, `generate`, VAD inference, a quality candidate, baseline replacement, production/default changes, or a formal matrix. It supersedes only the acquisition use of the immutable reviewed lock SHA-256 `470f9e0fba8cb0bc837660eae4173635bcc86212bea83324a02c0953d9c36793`; that file remains byte-identical.

Candidate `short-input-runtime-parity-bisect-v1`, the four cells, runner, worker, model, Mel tensors, CT2 runtime roots, prompt/options/fallback/parser logic and decision rule are unchanged. V2 adds only the missing fail-closed Python VAD boundary: exact source/asset/ONNX Runtime disk identities plus one ignored-local sanitized preflight artifact that the publisher must validate before consuming any cell. Raw Mel, tokens, decoded text, parser segments, model traces and canonical paths remain below `research/local/`.

A future acquisition preflight must run `whisper_short_vad_preflight.py` under the frozen interpreter and this exact lock. It must prove exact faster-whisper 1.2.1 Silero V6 returns one `[0,385637)` interval, preserves waveform SHA-256 `2cbf22e7635a41cf751401525e4358c19f2d452ae99c0ced78f65b6e9327e1c2`, uses ONNX Runtime 1.26.0 CPUExecutionProvider, and loads the frozen sibling `onnxruntime.dll`. Any drift stops before ASR model load.
...
<!-- SHORT-PARITY-IDENTITY:BEGIN -->
{
  ...
  "supersedesLockSha256": "470f9e0fba8cb0bc837660eae4173635bcc86212bea83324a02c0953d9c36793",
  "tools": {
    "parserOracle": {
    ...
    "publisher": {
      "sha256": "f2eaff2f823d74c4579757b1e7bf74e242d0d1a5d21f60c6bd8d1265330f8cb3",
      "sizeBytes": 32094
    },
    "pythonExecutable": {
    ...
    "vadPreflightTool": {
      "sha256": "34ac05c65d6bb416282d1ceb87a016a39839f998ea1e04bec42c0a69f5aaf772",
      "sizeBytes": 9375
    }
  },
  "vadPreflight": {
...
| `whisper_short_vad_preflight.py` | 9,375 | `34ac05c65d6bb416282d1ceb87a016a39839f998ea1e04bec42c0a69f5aaf772` |
| `publish_whisper_short_parity_bisect.py` | 32,094 | `f2eaff2f823d74c4579757b1e7bf74e242d0d1a5d21f60c6bd8d1265330f8cb3` |
| `publish_whisper_gpu_quality.py` | 68,715 | `ece07ee742992e4315fed0635c7c56feaa1fb6e5142e912173739f647901f30c` |
| `test_publish_whisper_short_parity_bisect.py` | 24,254 | `47ab1a940cdda1af1a873fa9c1f708ea54b238a756d4dcdf2b1cc074811ca019` |
| `test_whisper_short_parity_oracles.py` | 4,308 | `5e5e9b99bb0cc2539c94c2f04b2b8e0142f7b93700530e7da94055aa47d23236` |
